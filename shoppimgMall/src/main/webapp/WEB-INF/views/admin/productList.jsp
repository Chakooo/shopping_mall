            ...
            <% String strReferer=request.getHeader("referer"); if(strReferer==null){ %>
                ...
                <% return; } %>
                    ...
                    <head>
                        ...
                        <script src="/assets/js/admin_js/productList.js"></script>
                        <script src="https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js"
                            integrity="sha512-uto9mlQzrs59VwILcLiRYeLKPPbS/bT71da/OEBYEwcdNUk8jYIy+D176RYoop1Da+f9mvkYrmj5MCLZWEtQuA=="
                            crossorigin="anonymous" referrerpolicy="no-referrer"></script>
                        <link rel="stylesheet" href="/assets/css/admin_css/productList.css">
                            ...
                            <table class="prod_form_table">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>할인률</td>
                                        <td>
                                            <input type="number" name="" id="pi_discount_rate" min="0" max="100"
                                                placeholder="할인률">
                                        </td>
                                        <td>적릴률</td>
                                        <td>
                                            <input type="number" name="" id="pi_point_rate" min="0" max="100"
                                                placeholder="적립률">
                                        </td>
                                    </tr>
                                    <tr>
