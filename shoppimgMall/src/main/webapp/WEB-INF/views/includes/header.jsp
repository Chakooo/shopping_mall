                        ...
                        <div class="hc_top">
                            ...
                            <div class="user_menu">
                                ...
                                <c:if test="${seller!=null}">
                                    <a href="/seller/home/${seller.si_seq}">
                                        <span class="user_grade">
                                            <c:if test="${seller.si_grade==0}">사업자 등록이 필요합니다</c:if>
                                            <c:if test="${seller.si_grade==1}">정식 판매자</c:if>
                                            <c:if test="${seller.si_grade==99}">관리자</c:if>
                                        </span>
                                        ${seller.si_name}님</a>
                                    <span>|</span>
                            ...
                            <div class="search_area">
                                ...
                                <c:if test="${seller != null && seller.si_grade==1 }">
                                    <a href="/seller/home/${seller.si_seq}" id="seller_home" class="seller_home_icon">
                                        <img src="/assets/images/free-icon-house-5103132.png" alt=""
                                            style="width:35.99px;height:35.99px">
                                    </a>
                                </c:if>
                            ...
                            <div class="seller_list">
                                <c:forEach items="${sellerList}" var="seller">
                                    <c:if test="${seller.si_grade != 99}">
                                        <a href="/products/shop?si_seq=${seller.si_seq}">${seller.si_name}</a>
                                    </c:if>
                                </c:forEach>
                            </div>
                        </div>
