                ...
                <body>
                    ...
                    <div class="cart_container">
                                ...
                                <tbody>
                                    ...
                                    <c:forEach items="${list}" var="item">
                                        <tr class="cart_prod" data-seq="${item.pi_seq}" data-mi-seq=${member.mi_seq}
                                            data-si-seq=${item.pi_si_seq} data-pi-name=${item.pi_name}>
                                            <td>
                                            ...
                                            <td data-final-price="${item.discounted_price}"
                                                data-origin-price="${item.pi_price}">
                                                <button class="minus" data-seq="${item.pi_seq}"
                                                    data-user-seq="${member.mi_seq}">-</button>

                                                <!-- <span class="cnt">${item.sc_count}</span> -->
                                                <input type="text" class="cnt" value="${item.sc_count}"
                                                    style="display:inline-block; width: 50px;" data-seq="${item.pi_seq}"
                                                    data-stock="${item.pi_stock}" data-user-seq="${member.mi_seq}">

                                                <button class="plus" data-seq="${item.pi_seq}"
                                            ...
                                            <td>
                                                ...
                                                <c:if test="${item.pi_discount_rate ==0}">
                                                    <span class="origin_price" style="display:none">
                                                        ${item.pi_price * item.sc_count}
                                                    </span>
                        ...
                        <td colspan="2">
                            ...
                            <div class="order">
                                <button id="kakaoPay">결제 하기</button>
                                <!-- <button id="kakaoPay"><img src="/assets/images/payment_icon_yellow_large.png" alt=""> </button> -->
                                <ul>
